...
CREATE TABLE `banco` (
  ...
  `id_lista_bancos` int DEFAULT NULL,
  `agencia` bigint DEFAULT NULL,
  `conta` bigint DEFAULT NULL,
  `tipo` varchar(10) DEFAULT NULL,
  `cartao_credito` char(1) DEFAULT 'N',
...
INSERT INTO `banco` VALUES (1,'NUBANK',260,1,13265,'CORRENTE','N');
...
CREATE TABLE `financeiro` (
  ...
  `dt_lancamento` date DEFAULT (curdate()),
...
INSERT INTO `tb_users` VALUES (1,'admin','$2y$10$S9xp4/YHoS/G54Q23f2asu8t6trX3EE2YzTaBE9HXFimQEWjPjPn6',NULL),(2,'mmcs','123',NULL);
...
-- Dump completed on 2021-08-15 11:28:46
